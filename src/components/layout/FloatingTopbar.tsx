        ...
        <div className="flex items-center gap-4">
          <div className="relative w-56 lg:w-72">
            ...
            <input
              ...
              className="w-full neu-pressed bg-surface-container-lowest/80 text-on-surface text-xs rounded-xl pl-10 pr-4 py-2 placeholder:text-on-surface-variant/50 focus:outline-none focus:ring-1 focus:ring-secondary/50 border border-white/5"
            />
          </div>
